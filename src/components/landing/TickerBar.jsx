export default function TickerBar() {
  ...
  return (
    <div className="py-8 bg-surface overflow-hidden">
      <div className="relative flex">
        <div className="flex animate-marquee gap-8">
          {allKeywords.map((word, index) => (
            <div key={index} className="flex items-center gap-8 shrink-0">
              <span className="text-2xl font-semibold text-text-primary/20 whitespace-nowrap">
                {word}
              </span>
        ...
        <div className="flex animate-marquee gap-8" aria-hidden="true">
          {allKeywords.map((word, index) => (
